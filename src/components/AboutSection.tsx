    ...
    <section id="about" className="py-20 md:py-40 px-6 md:px-8 max-w-6xl mx-auto flex flex-col items-center text-center">
      ...
      >
        <motion.div 
          ...
          className="absolute -top-6 -right-6 w-24 h-24 border-t border-r border-primary-blue/20 rounded-tr-3xl -z-0" 
        />
        <motion.div 
          animate={{ y: [0, 10, 0], opacity: [0.3, 0.6, 0.3] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute -bottom-6 -left-6 w-24 h-24 border-b border-l border-primary-blue/20 rounded-bl-3xl -z-0" 
        />

        <div className="absolute inset-0 bg-primary-blue/5 rounded-[48px] rotate-3 -z-10 translate-x-3 translate-y-3" />
        
        <div className="aspect-[3/4] rounded-[32px] md:rounded-[48px] overflow-hidden cinematic-shadow border-[6px] border-white relative z-10 bg-natural-stone/10 ring-1 ring-primary-blue/5">
          <img 
        ...
        >
          <div className="h-[1px] w-8 bg-primary-blue/30 mb-4" />
          <div className="px-4 py-1.5 rounded-full bg-primary-blue/5 border border-primary-blue/10">
            <span className="text-[10px] md:text-xs uppercase tracking-[0.4em] text-primary-blue font-bold">CRP 04/48708</span>
          </div>
        </motion.div>

        <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-primary-blue/5 rounded-full blur-[100px] -z-20" />
        <div className="absolute -top-16 -left-16 w-64 h-64 bg-primary-blue/10 rounded-full blur-[100px] -z-20" />
      </motion.div>
      ...
      >
        <div className="space-y-4">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif leading-tight md:leading-[1.1] text-natural-ink italic">
            Um espaço seguro <br className="hidden sm:block"/><span className="italic text-primary-blue">para o seu sentir.</span>
          </h2>
        </div>
        ...
        <div className="max-w-2xl mx-auto text-left space-y-6 md:space-y-8 py-4">
          ...
          <p className="text-lg md:text-xl text-natural-ink/80 font-light leading-relaxed border-l-2 border-primary-blue/20 pl-6 md:pl-8 italic">
        ...
        <div className="grid sm:grid-cols-2 gap-4 lg:gap-6 pt-4 text-left">
          <motion.div 
            ...
            whileHover={{ y: -5 }}
            className="bg-primary-blue/5 border border-primary-blue/10 p-6 md:p-8 rounded-3xl space-y-3 md:space-y-4"
          >
            <Heart className="text-primary-blue w-5 h-5 md:w-6 md:h-6" strokeWidth={1.5} />
          ...
          <motion.div 
            ...
            className="bg-primary-blue/5 border border-primary-blue/10 p-6 md:p-8 rounded-3xl space-y-3 md:space-y-4"
          >
            <Shield className="text-primary-blue w-5 h-5 md:w-6 md:h-6" strokeWidth={1.5} />
        ...
        <div className="pt-12 md:pt-16 space-y-8 text-left">
          <motion.div 
            ...
            className="space-y-4"
          >
            <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] text-primary-blue font-bold">Qualificações e Experiência</span>
          ...
          <div className="grid gap-6">
            {[
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 shrink-0 bg-white rounded-2xl flex items-center justify-center cinematic-shadow border border-primary-blue/5">
                  <item.icon className="text-primary-blue w-5 h-5 md:w-6 md:h-6" strokeWidth={1.5} />
                </div>
                <div>
