        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 md:gap-12 mb-20 lg:mb-32 text-left">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-primary-blue/10 flex items-center justify-center text-primary-blue hover:bg-primary-blue hover:text-white transition-all group" title="WhatsApp">
                <MessageCircle size={18} className="group-hover:scale-110 transition-transform" />
              </a>
              <a href="mailto:thiagomeirelesfigueiro@hotmail.com.br" className="w-10 h-10 rounded-full border border-primary-blue/10 flex items-center justify-center text-primary-blue hover:bg-primary-blue hover:text-white transition-all group" title="Email">
          ...
          <div className="space-y-8">
            <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-primary-blue">Navegação</h4>
            <nav className="flex flex-col gap-4">
              {[
                ...
                <a 
                  key={item.name} 
                  href={item.href} 
                  className="text-sm font-medium text-natural-ink/70 hover:text-primary-blue transition-all flex items-center gap-2 group w-fit"
                >
                  <span className="w-0 h-px bg-primary-blue transition-all group-hover:w-4" />
                  {item.name}
                </a>
              ))}
            </nav>
          ...
          <div className="space-y-8">
            <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-primary-blue">Contatos</h4>
          ...
          <div className="space-y-8 bg-white/40 p-8 rounded-[32px] border border-primary-blue/5 cinematic-shadow">
            ...
            <button 
              ...
              className="w-full bg-primary-blue text-white py-4 rounded-2xl font-sans text-[10px] uppercase tracking-[0.2em] font-bold shadow-lg shadow-primary-blue/10 hover:shadow-primary-blue/20 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
            ...
            <div className="pt-2 flex items-center justify-center gap-2 grayscale hover:grayscale-0 transition-opacity opacity-40 hover:opacity-100">
              <Shield size={12} className="text-primary-blue" />
